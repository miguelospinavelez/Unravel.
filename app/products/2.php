...
<head>
    ...
    <title>Unravel. | Psilocybin Mushroom Powder</title>
...
<body>
    ...
    <section class="products">
        <h1>Psilocybin Mushroom Powder</h1>
        <a href="cart.php" class="cart-btn">cart <i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
       
            <div class="box-container">

                <?php
                $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE id = 2") or die('query failed');
