...
<head>
    ...
    <title>Unravel. | Psilocybin Starter Kit</title>
...
<body>
    ...
    <section class="products">
        <h1>Psilocybin Starter Kit</h1>
        <a href="cart.php" class="cart-btn">cart <i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
       
            <div class="box-container">

                <?php
                $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE id = 3") or die('query failed');
