...
<head>
    ...
    <title>Unravel. | Create or log in to your account</title>

    <!-- favicon link -->
    <link rel="icon" type="image/x-icon" href="imgs/icons/fav/8.ico">
...
<body class="login">
    ...
    <section class="header">
        ...
        <nav class="navbar">
            ...
            <a style="color:blueviolet; pointer-events: none;">log in</a>
        </nav>
