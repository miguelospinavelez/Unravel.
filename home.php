...
<head>
    ...
    <!-- favicon link -->
    <link rel="icon" type="image/x-icon" href="imgs/icons/fav/<?php echo (rand(1, 9));?>.ico">
...
<body>
    ...
    <section class="header">
        ...
        <nav class="navbar">
            ...
            <a href="home.php?logout=<?php echo $user_id; ?>" onclick="return confirm('are you sure you want to log out?')">exit</a>
                </nav>
